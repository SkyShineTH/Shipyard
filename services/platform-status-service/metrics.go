...
var (
	httpRequestsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Namespace: "shipyard",
			Subsystem: "platform_status_service",
			Name:      "http_requests_total",
			Help:      "Total HTTP requests handled by platform-status-service.",
		},
	...
	httpRequestDurationSeconds = prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Help:      "HTTP request duration in seconds for platform-status-service.",
